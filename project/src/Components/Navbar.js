...
const pages = ['ABOUT US', 'FAQs', 'TERMS & CONDITIONS', <a href="/reg" style={{color:"white",textDecoration:"none"}}>SIGNUP</a>,  <a href="/log" style={{color:"white",textDecoration:"none"}}>LOGIN</a>];
const settings = ['Profile', 'Dashboard',  <a href="/book" style={{color:"black",textDecoration:"none"}}>BOOK TICKETS</a>, 'Travel History', 'Logout'];
function Navbar() {
